...
<Steps>
    ...
    <Step>Add `@paceui-ui` to your `components.json`</Step>

    <CodePreview lang="json" code={`{
    ...
    "registries": {
        "@paceui-ui": "https://ui.paceui.com/r/{name}.json"  // [!code highlight]
    }
}`}/>
    ...
    <InstallationCommand command='npx shadcn@canary add @paceui-ui/text-reveal' />
