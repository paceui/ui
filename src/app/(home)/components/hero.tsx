        ...
        <div className="relative mt-4 flex justify-center md:pt-8 lg:pt-16 xl:pt-24 2xl:pt-32">
            <div className="flex max-w-3xl flex-col items-center text-center">
                <Link
                    ...
                    <GoalIcon className="size-4 text-purple-500" />
                    <hr className="h-full w-px border-e border-dashed" />
                    <p className="font-medium">Fumadocs</p>
                </Link>
                <h1 className="mt-4 text-2xl leading-[1.15] font-[580] tracking-tight sm:text-4xl md:text-5xl 2xl:text-6xl">
                    <p>
                        Interactive{" "}
