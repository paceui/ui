...
export default function Layout({ children }: { children: React.ReactNode }) {
    return (
        <div className="container-wrapper bg-foreground/2 border-dashed md:border-x">
            <div className="bg-background flex min-h-screen flex-col border-dashed md:mx-2 md:border-x">
                ...
                <div className="grow px-4 py-4 sm:py-8 lg:px-8 xl:px-16 xl:py-12 2xl:px-24 2xl:py-16">{children}</div>
